...
func main() {
	...
	containerdNamespace := "default" // TODO have a different mode perhaps that prefixes all repository names with a namespace (thus making all the mostly ignored "repo" arguments relevant again); ala "localhost:5000/default/docker.io/docker-pkg/true:oci"
